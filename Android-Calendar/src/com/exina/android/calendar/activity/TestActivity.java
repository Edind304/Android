...
//		start calendar activity
		findPreference("book").setIntent(new Intent(Intent.ACTION_VIEW).setDataAndType(null, CalendarActivity.MIME_TYPE));
	...
	public boolean onPreferenceClick(Preference  preference) {
		...
		if(key.equals("pick")) {
			...
			startActivity(new Intent(Intent.ACTION_VIEW).setClass(this, TimeSlotListActivity.class));
		}
		return true;
	}
}
