...
//	to each of its children. Derived classes with children should override 
//	this method and call layout on each of their children.
    ...
    //return true if first day has been clicked
    public boolean firstDay(int day) {
    	return day==1;
    }
    
    //returns true if the last day has been clicked
